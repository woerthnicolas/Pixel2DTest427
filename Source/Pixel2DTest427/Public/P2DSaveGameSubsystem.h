...
#include "P2DSaveGameSubsystem.generated.h"

class UP2DSaveGame;

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnSaveGameSignature, class UP2DSaveGame*, SaveObject);
...
class PIXEL2DTEST427_API UP2DSaveGameSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
