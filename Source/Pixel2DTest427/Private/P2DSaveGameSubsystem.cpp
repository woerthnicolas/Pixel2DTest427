...
#include "P2DSaveGameSubsystem.h"

#include "EngineUtils.h"
#include "P2DSaveGame.h"
...
void UP2DSaveGameSubsystem::HandleStartingNewPlayer(AController* NewPlayer)
{
...
bool UP2DSaveGameSubsystem::OverrideSpawnTransform(AController* NewPlayer)
{
...
void UP2DSaveGameSubsystem::SetSlotName(FString NewSlotName)
{
	// Ignore empty name
...
void UP2DSaveGameSubsystem::WriteSaveGame()
{
...
void UP2DSaveGameSubsystem::LoadSaveGame(FString InSlotName /*= ""*/)
{
